...
public class ApplicantFactory{
    ...
    public Applicant makeApplicantFromString(String fileLocation, Integer id) throws MalformedURLException, IOException, JSONException{
        ...
        return create(idString, name, skills, uploadDate, contactInfo, urls);
    }
