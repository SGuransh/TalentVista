...
//            System.out.println("File not found.");
    ...
    public Applicant makeApplicantFromString(String fileLocation, Integer id, String position) throws MalformedURLException, IOException, JSONException {
        ...
        OldApplicantBuilder builder = new OldApplicantBuilder();
        builder.buildApplicantId(id, data);
        builder.buildApplicantName(data);
        builder.buildApplicantContactInfo(data);
        builder.buildApplicantPersonalUrls(data);
        builder.buildApplicantSkills(data);
        builder.buildApplicantPosition(position);
        builder.buildApplicantUploadDate();
        return builder.getApplicant_();
    }
}