...
public class ApplicantFactory{
    ...
    public String stringFromFile(String fileLocation, String id) throws MalformedURLException, IOException{
        try {
    ...
    public Applicant makeApplicantFromString(String fileLocation, String id) throws MalformedURLException, IOException, JSONException{
//         String str = stringFromFile(fileLocation, id);
        ...
        String name = new JSONObject(data.get("name").toString()).getString("full_name");   // response.data.name.full_name
        String last_name = new JSONObject(data.get("name").toString()).getString("last_name");   // response.data.name.last_name
        ...
        id  = last_name + "00" + id;
        return create(id, name, skills, uploadDate, contactInfo, urls);
    }

    public Applicant create(String id, String name, ArrayList<String> skills, String uploadDate, HashMap<String, String> contactInfo, ArrayList<String> personal_urls) {
        return new Applicant(id, name, skills, uploadDate, contactInfo, personal_urls);
    }

    public static void main(String[] args) {
        ApplicantFactory af = new ApplicantFactory();
        try{
            Applicant first = af.makeApplicantFromString("fake", "1");
            System.out.println(first);
            System.out.println(first.getName());
            System.out.println(first.getSkills());
            System.out.println(first.getUploadDate());
            System.out.println(first.getContactInfo());
            System.out.println(first.personal_urls());
