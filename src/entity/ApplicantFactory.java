...
//        }
    ...
    public Applicant makeApplicantFromString(String fileLocation, Integer id) throws MalformedURLException, IOException, IOException{
...
//        return create(idString, name, skills, uploadDate, contactInfo, urls);
        return new Applicant("","",  new ArrayList<>(), "", new HashMap<>(), new ArrayList<String>(), "");
